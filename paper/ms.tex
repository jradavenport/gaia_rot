...
\caption{Residual of log rotation periods about the \citet{meibom2011} 600 Myr isochrone, using the log-linear extrapolation between 6000--6500 K shown in Figure \ref{fig:gyro}.
}
\label{fig:diff}
\end{figure}
