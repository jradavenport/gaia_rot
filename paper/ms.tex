...
%%%%%%%%%%%%%%%%%%%%%%
\title{Rotating Stars from \Kepler Observed with Gaia}
...
of course, Kepler useful for calibrations for Gaia, e.g. log(g) \citep{creevey2013}
...
using CDS X-Match service, we match the catalogs from 
